            ...
            switch (menu(operazioni, keyboard)) {
                case 1:
                    ...
                    if (contattiInseriti < nMax) {
                        rubrica[contattiInseriti] = leggiPersona(Sitel, keyboard);
                        contattiInseriti++;
                    } else {
                ...
                case 3: {
                    ...
                    if (contattiInseriti != 0) {
                        if (ricerca(rubrica, leggiPersona(false, keyboard), contattiInseriti)) {
                ...
                case 4:
                    ...
                    if (contattiInseriti != 0) {
                        posizione = RicercaIndex(rubrica, leggiPersona(false, keyboard), contattiInseriti);
                        if (posizione != -1) {
